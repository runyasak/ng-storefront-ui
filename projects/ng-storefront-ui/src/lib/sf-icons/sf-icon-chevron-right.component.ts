  ...
  @Component({
    ...
    template: `<sf-icon-base [size]="size" viewBox="0 0 24 24" data-testid="chevron-right">
      <svg:path d='M8.705 17.297a.998.998 0 0 1-.001-1.41l3.876-3.885-3.876-3.885a.998.998 0 0 1 1.412-1.41l4.587 4.588a1 1 0 0 1 0 1.414l-4.587 4.588a.997.997 0 0 1-1.411 0Z'/>      
    </sf-icon-base>`,
